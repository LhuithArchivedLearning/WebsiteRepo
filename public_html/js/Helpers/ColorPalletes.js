...
var dirtColors = 
[
new ColorData (0x5a554c, new THREE.Vector3(90,85,76)),
new ColorData (0x767676, new THREE.Vector3	(118,118,118)),
new ColorData (0x93928c, new THREE.Vector3(147,146,140)),
new ColorData (0x362d01, new THREE.Vector3	(54,45,1)),
new ColorData (0x856335, new THREE.Vector3(133 ,99 ,53)),
];

var goldColors = 
[
new ColorData (0xd0ba5f, new THREE.Vector3(208,186,95)),
new ColorData (0xc7ab52, new THREE.Vector3(199,171,82)),
new ColorData (0xbd9434, new THREE.Vector3(189,148,52)),
new ColorData (0xc5a047, new THREE.Vector3(197,160,71)),
new ColorData (0xd8b45d, new THREE.Vector3(216,180,93)),
];

//Leprecuan + fire
var firecaunColors = 
[
new ColorData (0xbf4d00, new THREE.Vector3(191,77,0)),
new ColorData (0x922b2b, new THREE.Vector3(146,43,43)),
new ColorData (0xbf983b, new THREE.Vector3(191,152,59)),
new ColorData (0x5e7a47, new THREE.Vector3(94,122,71)),
new ColorData (0x18926a, new THREE.Vector3(24,146,106)),
];
    
var lunaColors = 
[
new ColorData (0xa96fb4, new THREE.Vector3(169,111,180)),
new ColorData (0x65ccbf, new THREE.Vector3(101,204,191)),
new ColorData (0x3280c7, new THREE.Vector3(50,128,199)),
new ColorData (0xc2d4b9, new THREE.Vector3(194,212,185)),
new ColorData (0xc5a9b6, new THREE.Vector3(197,169,182)),
];

var fearyColors = 
[
new ColorData (0x92e5cc, new THREE.Vector3(146,229,204)),
new ColorData (0x91d4cc, new THREE.Vector3(145,212,204)),
new ColorData (0x93c5cd, new THREE.Vector3(147,197,205)),
new ColorData (0x91b4cd, new THREE.Vector3(145,180,205)),
new ColorData (0x91a2cb, new THREE.Vector3(145,162,203)),
];

var chocolatColors = 
[
new ColorData (0xe9aa50, new THREE.Vector3(233,170,80)),
new ColorData (0x2f2521, new THREE.Vector3(47,37,33)),
new ColorData (0xe9e9e9, new THREE.Vector3(233,233,233)),
new ColorData (0x090605, new THREE.Vector3(9,6,5)),
new ColorData (0x45392f, new THREE.Vector3(69,57,47)),
];

var grosscreamColors = 
[
new ColorData (0x717f60, new THREE.Vector3(113,127,96)),
new ColorData (0xcecece, new THREE.Vector3(206,206,206)),
new ColorData (0x231e1a, new THREE.Vector3(35,30,26)),
new ColorData (0xfff3e5, new THREE.Vector3(255,243,229)),
new ColorData (0xffb5b5, new THREE.Vector3(255,181,181)),
];

var madCloudColors = 
[
new ColorData (0xc4e6ff, new THREE.Vector3(196,230,255)),
new ColorData (0xe69598, new THREE.Vector3(230,149,152)),
new ColorData (0xcb2c31, new THREE.Vector3(203,44,49)),
new ColorData (0x85bdde, new THREE.Vector3(133,189,222)),
new ColorData (0xccebfb, new THREE.Vector3(204,235,251)),
];

var pastelsColors = 
[
new ColorData (0x1b85b8, new THREE.Vector3(27,133,184)),
new ColorData (0x5a5255, new THREE.Vector3(90,82,85)),
new ColorData (0x559e83, new THREE.Vector3(85,158,131)),
new ColorData (0xae5a41, new THREE.Vector3(174,90,65)),
new ColorData (0xc3cb71, new THREE.Vector3(195,203,113)),
];

var lightRetroColors = 
[
new ColorData (0xe5c3c6, new THREE.Vector3(229,195,198)),
new ColorData (0xe1e9b7, new THREE.Vector3(225,233,183)),
new ColorData (0xf96161, new THREE.Vector3(249,97,97)),
new ColorData (0xbcd2d0, new THREE.Vector3(188,210,208)),
new ColorData (0xd0b783, new THREE.Vector3(208,183,131)),
];

var shartNebulaColors = 
[
new ColorData (0xFFCF77, new THREE.Vector3(255,207,119)),
new ColorData (0xE7EB90, new THREE.Vector3(231,235,144)),
new ColorData (0xFADF63, new THREE.Vector3(250,223,99)),
new ColorData (0xE6AF2E, new THREE.Vector3(230,175,46)),
new ColorData (0x241012, new THREE.Vector3(36,16,18)),
];

var littleMouseColors = 
[
new ColorData (0x04BFBF, new THREE.Vector3(4,191,191)),
new ColorData (0xCAFCD8, new THREE.Vector3(202,252,216)),
new ColorData (0xF7E967, new THREE.Vector3(247,233,103)),
new ColorData (0xA9CF54, new THREE.Vector3(169,207,84)),
new ColorData (0x588F27, new THREE.Vector3(88,143,39)),
];

var pudgyCamelColors = 
[
new ColorData (0xfdd9d2, new THREE.Vector3(253,217,210)),
new ColorData (0x9ad6e3, new THREE.Vector3(154,214,227)),
new ColorData (0x89e8e1, new THREE.Vector3(137,232,225)),
new ColorData (0xbfefff, new THREE.Vector3(191,239,255)),
new ColorData (0xf8e6e4, new THREE.Vector3(248,230,228)),
];
...
[
new ColorData (0xbfefff, new THREE.Vector3(191,239,255)),
new ColorData (0xc39679, new THREE.Vector3(195,150,121)),
new ColorData (0xF6A3A3, new THREE.Vector3(246,163,163)),
new ColorData (0x6f1f19, new THREE.Vector3(111,31,25)),
new ColorData (0x4a708b, new THREE.Vector3(74,112,139)),
];

var BlushingSunriseColor = 
[
new ColorData (0xe1f7d5, new THREE.Vector3(225,247,213)),
new ColorData (0xffbdbd, new THREE.Vector3(255,189,189)),
new ColorData (0xc9c9ff, new THREE.Vector3(201,201,255)),
new ColorData (0xffffff, new THREE.Vector3(255,255,255)),
new ColorData (0xf1cbff, new THREE.Vector3(241,203,255)),
];
